...
import { useIncidentsViewModel } from '../viewmodel/useIncidentsViewModel';

export const IncidentsScreen: React.FC = () => {
  const { state, actions } = useIncidentsViewModel();
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Module M12: Incidents</Text>
