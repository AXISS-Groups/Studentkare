...
import { useTeleconsultViewModel } from '../viewmodel/useTeleconsultViewModel';

export const TeleconsultScreen: React.FC = () => {
  const { state, actions } = useTeleconsultViewModel();
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Module M10: Teleconsult</Text>
