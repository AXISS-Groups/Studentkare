...
export const authApi = {
  ...
  async verifyOtp(
    ...
    try {
      ...
      return {
        success: false,
        message: 'Unable to connect to authentication server. Offline authentication is disabled.',
      };
    }
  },
  ...
  async signup(data: {
    ...
    try {
      ...
      return {
        success: false,
        message: 'Unable to connect to registration server. Offline registration is disabled.',
      };
    }
  },
