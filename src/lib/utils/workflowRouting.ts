...
export const routePaths = ['shop', 'care', 'checkout', 'pricing', 'login', 'signup', 'welcome', 'logged-out', 'profile-setup', 'permissions', 'account-ready', 'billing', 'health', 'profile', 'digital-id', 'records', 'insurance', 'orders', 'appointments', 'medications', 'health-camp', 'notifications', 'care-navigator', 'preventive-care', 'report-reviews', 'earnings', 'support', 'movement', 'devices', 'clinical-notes', 'lifeshare', 'medical-incident', 'meo', 'admin', 'admin/billing', 'admin/catalog', 'admin/accounts', 'admin/requests', 'admin/support', 'admin/audit', 'admin/integrations', 'admin/telemetry', 'admin/knowledge', 'admin/intake', 'admin/preventive', 'admin/activity', 'vendor', 'clinician', 'campus', 'prescriptions', 'ayush', 'clinical-review', 'dispensing', 'lab-queue'] as const;
export type RoutePath = typeof routePaths[number];
export const publicRoutes: RoutePath[] = ['shop', 'care', 'pricing', 'login', 'signup', 'welcome', 'logged-out'];
